          ...
          <div className="flex flex-col items-center mb-6 space-y-4 px-20">
            ...
            <div className="flex justify-center space-x-2">
              <a
                href="#!"
                type="button"
                className="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-secondary focus:outline-none focus:ring-0 text-slate-100 hover:bg-secondary-900"
