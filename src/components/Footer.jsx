...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center bg-primary text-center text-surface text-slate">
      ...
      <div className="container pt-9">
        <div className="flex flex-wrap justify-center items-center">
          ...
          <div className="flex flex-col items-center mb-6 space-y-4 px-20">
            {/* Alamat */}
            <p className="text-xl font-semibold text-surface text-slate">
              Ikuti Kami :
            </p>
            ...
            <div className="flex justify-center space-x-2">
              <a
                href="#!"
                type="button"
                className="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-secondary focus:outline-none focus:ring-0 text-slate hover:bg-secondary-900"
          ...
          <a
            ...
            <p className="text-lg text-surface text-slate">
